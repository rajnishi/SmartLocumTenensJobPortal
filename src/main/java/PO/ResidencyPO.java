...
public class ResidencyPO extends BasePage {
    public ResidencyPO(WebDriver driver) { super(driver);  }
    //*****************Locators of Residency tab************//
    ...
    public By ResiTab_xpath = By.xpath("//a[contains(text(), 'Residency')]");
    public By ResiAddNew_xpath = By.xpath("//span[text() = ' Add New ']");

    public By ResiType_xpath = By.xpath("//mat-select[@name= 'residencyTypeId']");
    public By ResiOpt_xpath = By.xpath("//span[contains((text()), 'Radiology')]");
    ...
    public By DegreeOpt_xpath = By.xpath("//span[contains((text()), ' MD ')]");
    ...
    public By ToastMessageSpec_xpath = By.xpath("//div[@aria-label = 'A new residency has been successfully created.']");
