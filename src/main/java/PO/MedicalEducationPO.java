...
public class MedicalEducationPO extends BasePage {
    public MedicalEducationPO(WebDriver driver) {
        super(driver);
    }
    //*****************Locators of Medical Education tab************//
    ...
    public By MedEduTab_xpath = By.xpath("//a[contains(text(), 'Medical Education')]");
    public By MedEduAddNew_xpath = By.xpath("//span[text() = ' Add New ']");
    ...
    public By RsoluOpt_xpath = By.xpath("//span[contains((text()), ' DO ')]");
    ...
    public By ToastMessageSpec_xpath = By.xpath("//div[@aria-label = 'A new medical education entry has been successfully created.']");
